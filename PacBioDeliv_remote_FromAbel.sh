...
##########################################
This shell script creates a folder structure:
...
echo "The user wants raw data"
   ...
   rsync -av $extSampleName.tgz halfdanr@login.norstore.uio.no:/projects/NS9012K/www/hts-nonsecure.uio.no/ProjectHalTest\_$refLastNameCust\_$sampleType\_$(date +%Y-%m-%d)
else
